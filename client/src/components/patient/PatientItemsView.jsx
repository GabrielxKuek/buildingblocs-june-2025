    ...
    return (
        <div className="w-full">
            <div className="mb-6">
                ...
                <p className="text-muted-foreground">Click on any item to interact or view actions</p>
            </div>

            {items.length === 0 ? (
                <div className="text-center py-12">
                    <p className="text-muted-foreground text-lg">No items yet</p>
                    <p className="text-muted-foreground">Upload or generate items using the button in the sidebar</p>
                </div>
            ) : (
